# tcp_dweet
Let's dweet! A simple TCP/IP stack and a dweet.io demo application built on top
of my PIC32 framework.

This simple TCP layer has been developed for establishing a connection with
