...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/tcp_dweet.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=src/framework/hal/adc.c src/framework/hal/can.c src/framework/hal/eep.c src/framework/hal/ethmac.c src/framework/hal/ethphy.c src/framework/hal/ic.c src/framework/hal/int.c src/framework/hal/port.c src/framework/hal/pwm.c src/framework/hal/tmr.c src/framework/hal/uart.c src/framework/sal/dio/inch.c src/framework/sal/dio/outch.c src/framework/sal/rtos/rtos.c src/framework/sal/rtos/rtos_cfg.c src/framework/sal/sys/exc.c src/framework/sal/sys/main.c src/framework/sal/tcpip/arp.c src/framework/sal/tcpip/dhcp.c src/framework/sal/tcpip/icmp.c src/framework/sal/tcpip/ipv4.c src/framework/sal/tcpip/tcp.c src/framework/sal/tcpip/udp.c src/app/app_dweet.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/framework/hal/adc.o ${OBJECTDIR}/src/framework/hal/can.o ${OBJECTDIR}/src/framework/hal/eep.o ${OBJECTDIR}/src/framework/hal/ethmac.o ${OBJECTDIR}/src/framework/hal/ethphy.o ${OBJECTDIR}/src/framework/hal/ic.o ${OBJECTDIR}/src/framework/hal/int.o ${OBJECTDIR}/src/framework/hal/port.o ${OBJECTDIR}/src/framework/hal/pwm.o ${OBJECTDIR}/src/framework/hal/tmr.o ${OBJECTDIR}/src/framework/hal/uart.o ${OBJECTDIR}/src/framework/sal/dio/inch.o ${OBJECTDIR}/src/framework/sal/dio/outch.o ${OBJECTDIR}/src/framework/sal/rtos/rtos.o ${OBJECTDIR}/src/framework/sal/rtos/rtos_cfg.o ${OBJECTDIR}/src/framework/sal/sys/exc.o ${OBJECTDIR}/src/framework/sal/sys/main.o ${OBJECTDIR}/src/framework/sal/tcpip/arp.o ${OBJECTDIR}/src/framework/sal/tcpip/dhcp.o ${OBJECTDIR}/src/framework/sal/tcpip/icmp.o ${OBJECTDIR}/src/framework/sal/tcpip/ipv4.o ${OBJECTDIR}/src/framework/sal/tcpip/tcp.o ${OBJECTDIR}/src/framework/sal/tcpip/udp.o ${OBJECTDIR}/src/app/app_dweet.o
POSSIBLE_DEPFILES=${OBJECTDIR}/src/framework/hal/adc.o.d ${OBJECTDIR}/src/framework/hal/can.o.d ${OBJECTDIR}/src/framework/hal/eep.o.d ${OBJECTDIR}/src/framework/hal/ethmac.o.d ${OBJECTDIR}/src/framework/hal/ethphy.o.d ${OBJECTDIR}/src/framework/hal/ic.o.d ${OBJECTDIR}/src/framework/hal/int.o.d ${OBJECTDIR}/src/framework/hal/port.o.d ${OBJECTDIR}/src/framework/hal/pwm.o.d ${OBJECTDIR}/src/framework/hal/tmr.o.d ${OBJECTDIR}/src/framework/hal/uart.o.d ${OBJECTDIR}/src/framework/sal/dio/inch.o.d ${OBJECTDIR}/src/framework/sal/dio/outch.o.d ${OBJECTDIR}/src/framework/sal/rtos/rtos.o.d ${OBJECTDIR}/src/framework/sal/rtos/rtos_cfg.o.d ${OBJECTDIR}/src/framework/sal/sys/exc.o.d ${OBJECTDIR}/src/framework/sal/sys/main.o.d ${OBJECTDIR}/src/framework/sal/tcpip/arp.o.d ${OBJECTDIR}/src/framework/sal/tcpip/dhcp.o.d ${OBJECTDIR}/src/framework/sal/tcpip/icmp.o.d ${OBJECTDIR}/src/framework/sal/tcpip/ipv4.o.d ${OBJECTDIR}/src/framework/sal/tcpip/tcp.o.d ${OBJECTDIR}/src/framework/sal/tcpip/udp.o.d ${OBJECTDIR}/src/app/app_dweet.o.d
...
# Source Files
SOURCEFILES=src/framework/hal/adc.c src/framework/hal/can.c src/framework/hal/eep.c src/framework/hal/ethmac.c src/framework/hal/ethphy.c src/framework/hal/ic.c src/framework/hal/int.c src/framework/hal/port.c src/framework/hal/pwm.c src/framework/hal/tmr.c src/framework/hal/uart.c src/framework/sal/dio/inch.c src/framework/sal/dio/outch.c src/framework/sal/rtos/rtos.c src/framework/sal/rtos/rtos_cfg.c src/framework/sal/sys/exc.c src/framework/sal/sys/main.c src/framework/sal/tcpip/arp.c src/framework/sal/tcpip/dhcp.c src/framework/sal/tcpip/icmp.c src/framework/sal/tcpip/ipv4.c src/framework/sal/tcpip/tcp.c src/framework/sal/tcpip/udp.c src/app/app_dweet.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/tcp_dweet.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/src/framework/sal/tcpip/arp.o: src/framework/sal/tcpip/arp.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src/framework/sal/tcpip 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/arp.o.d 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/arp.o 
	@${FIXDEPS} "${OBJECTDIR}/src/framework/sal/tcpip/arp.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PIC32MXSK=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src" -MMD -MF "${OBJECTDIR}/src/framework/sal/tcpip/arp.o.d" -o ${OBJECTDIR}/src/framework/sal/tcpip/arp.o src/framework/sal/tcpip/arp.c   
	
${OBJECTDIR}/src/framework/sal/tcpip/dhcp.o: src/framework/sal/tcpip/dhcp.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src/framework/sal/tcpip 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/dhcp.o.d 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/dhcp.o 
	@${FIXDEPS} "${OBJECTDIR}/src/framework/sal/tcpip/dhcp.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PIC32MXSK=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src" -MMD -MF "${OBJECTDIR}/src/framework/sal/tcpip/dhcp.o.d" -o ${OBJECTDIR}/src/framework/sal/tcpip/dhcp.o src/framework/sal/tcpip/dhcp.c   
	
${OBJECTDIR}/src/framework/sal/tcpip/icmp.o: src/framework/sal/tcpip/icmp.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src/framework/sal/tcpip 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/icmp.o.d 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/icmp.o 
	@${FIXDEPS} "${OBJECTDIR}/src/framework/sal/tcpip/icmp.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PIC32MXSK=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src" -MMD -MF "${OBJECTDIR}/src/framework/sal/tcpip/icmp.o.d" -o ${OBJECTDIR}/src/framework/sal/tcpip/icmp.o src/framework/sal/tcpip/icmp.c   
	
${OBJECTDIR}/src/framework/sal/tcpip/ipv4.o: src/framework/sal/tcpip/ipv4.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src/framework/sal/tcpip 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/ipv4.o.d 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/ipv4.o 
	@${FIXDEPS} "${OBJECTDIR}/src/framework/sal/tcpip/ipv4.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PIC32MXSK=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src" -MMD -MF "${OBJECTDIR}/src/framework/sal/tcpip/ipv4.o.d" -o ${OBJECTDIR}/src/framework/sal/tcpip/ipv4.o src/framework/sal/tcpip/ipv4.c   
	
${OBJECTDIR}/src/framework/sal/tcpip/tcp.o: src/framework/sal/tcpip/tcp.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src/framework/sal/tcpip 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/tcp.o.d 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/tcp.o 
	@${FIXDEPS} "${OBJECTDIR}/src/framework/sal/tcpip/tcp.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PIC32MXSK=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src" -MMD -MF "${OBJECTDIR}/src/framework/sal/tcpip/tcp.o.d" -o ${OBJECTDIR}/src/framework/sal/tcpip/tcp.o src/framework/sal/tcpip/tcp.c   
	
${OBJECTDIR}/src/framework/sal/tcpip/udp.o: src/framework/sal/tcpip/udp.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src/framework/sal/tcpip 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/udp.o.d 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/udp.o 
	@${FIXDEPS} "${OBJECTDIR}/src/framework/sal/tcpip/udp.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PIC32MXSK=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src" -MMD -MF "${OBJECTDIR}/src/framework/sal/tcpip/udp.o.d" -o ${OBJECTDIR}/src/framework/sal/tcpip/udp.o src/framework/sal/tcpip/udp.c   
	
${OBJECTDIR}/src/app/app_dweet.o: src/app/app_dweet.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src/app 
	@${RM} ${OBJECTDIR}/src/app/app_dweet.o.d 
	@${RM} ${OBJECTDIR}/src/app/app_dweet.o 
	@${FIXDEPS} "${OBJECTDIR}/src/app/app_dweet.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PIC32MXSK=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src" -MMD -MF "${OBJECTDIR}/src/app/app_dweet.o.d" -o ${OBJECTDIR}/src/app/app_dweet.o src/app/app_dweet.c   
...
${OBJECTDIR}/src/framework/sal/tcpip/arp.o: src/framework/sal/tcpip/arp.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/arp.o.d 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/arp.o 
	@${FIXDEPS} "${OBJECTDIR}/src/framework/sal/tcpip/arp.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src" -MMD -MF "${OBJECTDIR}/src/framework/sal/tcpip/arp.o.d" -o ${OBJECTDIR}/src/framework/sal/tcpip/arp.o src/framework/sal/tcpip/arp.c   
	
${OBJECTDIR}/src/framework/sal/tcpip/dhcp.o: src/framework/sal/tcpip/dhcp.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src/framework/sal/tcpip 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/dhcp.o.d 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/dhcp.o 
	@${FIXDEPS} "${OBJECTDIR}/src/framework/sal/tcpip/dhcp.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src" -MMD -MF "${OBJECTDIR}/src/framework/sal/tcpip/dhcp.o.d" -o ${OBJECTDIR}/src/framework/sal/tcpip/dhcp.o src/framework/sal/tcpip/dhcp.c   
	
${OBJECTDIR}/src/framework/sal/tcpip/icmp.o: src/framework/sal/tcpip/icmp.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src/framework/sal/tcpip 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/icmp.o.d 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/icmp.o 
	@${FIXDEPS} "${OBJECTDIR}/src/framework/sal/tcpip/icmp.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src" -MMD -MF "${OBJECTDIR}/src/framework/sal/tcpip/icmp.o.d" -o ${OBJECTDIR}/src/framework/sal/tcpip/icmp.o src/framework/sal/tcpip/icmp.c   
	
${OBJECTDIR}/src/framework/sal/tcpip/ipv4.o: src/framework/sal/tcpip/ipv4.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src/framework/sal/tcpip 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/ipv4.o.d 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/ipv4.o 
	@${FIXDEPS} "${OBJECTDIR}/src/framework/sal/tcpip/ipv4.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src" -MMD -MF "${OBJECTDIR}/src/framework/sal/tcpip/ipv4.o.d" -o ${OBJECTDIR}/src/framework/sal/tcpip/ipv4.o src/framework/sal/tcpip/ipv4.c   
	
${OBJECTDIR}/src/framework/sal/tcpip/tcp.o: src/framework/sal/tcpip/tcp.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src/framework/sal/tcpip 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/tcp.o.d 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/tcp.o 
	@${FIXDEPS} "${OBJECTDIR}/src/framework/sal/tcpip/tcp.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src" -MMD -MF "${OBJECTDIR}/src/framework/sal/tcpip/tcp.o.d" -o ${OBJECTDIR}/src/framework/sal/tcpip/tcp.o src/framework/sal/tcpip/tcp.c   
	
${OBJECTDIR}/src/framework/sal/tcpip/udp.o: src/framework/sal/tcpip/udp.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src/framework/sal/tcpip 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/udp.o.d 
	@${RM} ${OBJECTDIR}/src/framework/sal/tcpip/udp.o 
	@${FIXDEPS} "${OBJECTDIR}/src/framework/sal/tcpip/udp.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src" -MMD -MF "${OBJECTDIR}/src/framework/sal/tcpip/udp.o.d" -o ${OBJECTDIR}/src/framework/sal/tcpip/udp.o src/framework/sal/tcpip/udp.c   
	
${OBJECTDIR}/src/app/app_dweet.o: src/app/app_dweet.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src/app 
	@${RM} ${OBJECTDIR}/src/app/app_dweet.o.d 
	@${RM} ${OBJECTDIR}/src/app/app_dweet.o 
	@${FIXDEPS} "${OBJECTDIR}/src/app/app_dweet.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src" -MMD -MF "${OBJECTDIR}/src/app/app_dweet.o.d" -o ${OBJECTDIR}/src/app/app_dweet.o src/app/app_dweet.c   
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/tcp_dweet.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_PIC32MXSK=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/tcp_dweet.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}              -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PIC32MXSK=1,--defsym=_min_heap_size=44960,--defsym=_min_stack_size=2048,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/tcp_dweet.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/tcp_dweet.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=_min_heap_size=44960,--defsym=_min_stack_size=2048,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	${MP_CC_DIR}/xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/tcp_dweet.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
